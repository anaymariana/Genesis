...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-03-2026 a las 16:42:06
...
ALTER TABLE `historico`
  ...
  ADD CONSTRAINT `historico_ibfk_2` FOREIGN KEY (`id_pregunta`) REFERENCES `preguntas` (`id_pregunta`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `preguntas`
--
ALTER TABLE `preguntas`
  ADD CONSTRAINT `preguntas_ibfk_1` FOREIGN KEY (`id_tema`) REFERENCES `temas` (`id_tema`) ON DELETE CASCADE ON UPDATE CASCADE;
